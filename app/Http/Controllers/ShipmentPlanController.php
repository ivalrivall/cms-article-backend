...
class ShipmentPlanController extends BaseController
{
    ...
    /**
     * get printed data order inside shipment plan
     * only admin
     */
    public function getPrintedData(Request $request)
    {
        ...
        try {
            $result = $this->shipmentPlanService->getPickupListService($data);
        } catch (Exception $e) {
            DB::rollback();
            return $this->sendError($e->getMessage());
        }
    ...
    public function update(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $result = $this->shipmentPlanService->updateShipmentPlanService($data);
        } catch (Exception $e) {
            DB::rollback();
            return $this->sendError($e->getMessage());
        }
     ...
     */
    public function getHistoryShipmentDriver(Request $request)
    {
        $data = $request->only([
            'userId',
            'startDate',
        ...
        DB::beginTransaction();
        try {
            $result = $this->shipmentPlanService->getHistoryShipmentService($data);
        } catch (Exception $e) {
            DB::rollback();
            return $this->sendError($e->getMessage());
        }
