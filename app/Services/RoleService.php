...
class RoleService {
     ...
     * @return String
     */
    public function validateRoleLogin($user, $type, $isConnectGoogle)
    {
        if ($isConnectGoogle) {
            if ($user->google_id == null) {
                throw new InvalidArgumentException('Email ini belum terhubung dengan google, silahkan login melalui google');
            }
        } else {
            if ($user->google_id !== null) {
                throw new InvalidArgumentException('Email ini sudah terhubung dengan google, silahkan login melalui google');
            }
        }
